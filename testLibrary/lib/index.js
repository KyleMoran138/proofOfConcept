...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var api, carData, car, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('Sending request');
                return [4 /*yield*/, (new DroneMobileAPI({
                    ...
                    }).init(process.env.DRONE_USERNAME || '', process.env.DRONE_PASSWORD || ''))];
            case 1:
                api = _a.sent();
                return [4 /*yield*/, api.getCarData()];
            case 2:
                carData = _a.sent();
                car = carData === null || carData === void 0 ? void 0 : carData.results[0];
                if (!car) {
                    throw new Error('No cars on account!');
                }
                return [4 /*yield*/, api.sendCommand(car.device_key, RemoteCommand.REFRESH)];
            case 3:
                response = _a.sent();
                if (!response) {
